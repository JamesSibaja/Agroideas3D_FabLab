...
#             object_instance = modelo3d.objects.filter(id=self.kwargs['slideId'])
...
# #         if placaID:
# #             mySlide = modelo3d.objects.get(id=placaID)
...
# #             mySlide = modelo3d.objects.get(id=request.POST.get('slide'))
# #             # mySlide = None
# #             # # print(request.POST.get('slide', ''))
# #             # for slide in mySlides:
# #             #     mySlide = slide
...
#         context['noteGeojson'] = self.get_object().geojson_data
...
#     items = modelo3d.objects.filter( assembled=True)
...
#         items = modelo3d.objects.filter(consulta)
